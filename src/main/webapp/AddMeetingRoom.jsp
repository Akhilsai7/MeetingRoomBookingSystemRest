...
<body>
	...
	<form name="NewUser" style="text-align: center" method="post" action="FacilityManagerServlet?varname=AddMeeting">
		<h2 align="center">Adding meeting Room</h2>
		<table align="center">
			<tr>
				<td>ID:</td>
				<td><input type="text" name="meetingroomid" ></td>
			</tr>
			<tr>
				<td>MeetingRoom name:</td>
				<td><input type="text" name="meetingroomname"></td>
			</tr>
			<tr>
